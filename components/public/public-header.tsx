...
export function PublicHeader() {
  return (
    <header className="sticky top-0 z-[var(--z-sticky)] border-b border-surface-line/80 bg-surface-page/95 backdrop-blur-sm">
      <div className="public-container flex h-14 items-center justify-between gap-4 lg:h-16">
        <Link className="flex min-w-0 shrink-0 items-center gap-3" href="/">
          <div
            aria-hidden="true"
            className="flex h-10 w-10 items-center justify-center rounded-full bg-brand-green-700 text-sm font-bold text-white shadow-public1"
          >
            AM
          </div>
